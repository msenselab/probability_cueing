...
%    rects = ones(8,2)*box_size;     % sizes of each container
    ...
    v.dispText(['Visual Search \n', ...
        'In this experiment, you will see a display with objects (circle/diamond). And one of the shapes is different from the other seven. \n', ...
        ...
        if mod(iTrl,blk_trials) == 0 && iTrl < exp.maxTrls
            if iTrl == (exp.maxTrls+blk_trials)/2
                v.dispText(['You have finished half of the experiment\n', ...
                         ...
                         'You could get some water from the experimenter if you like']); % Add halfway message here
            else
